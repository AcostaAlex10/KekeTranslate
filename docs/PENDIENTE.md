...
Actualizado el 2026-09-06. Lo que era el punto 1 —que la sesión no sobrevivía a
recargar la página— está hecho y contado en [`ESTADO.md`](ESTADO.md). El estado de lo que ya funciona está en
[`ESTADO.md`](ESTADO.md); el contexto de producto, en [`../PRODUCT.md`](../PRODUCT.md).

---

## 1. Traducir, con el idioma elegido en cada clase
...
## 2. La grabadora integrada no aguanta una clase
...
## 3. Medir el consumo por persona
